...
> [!TIP]
>
> If you use [Task](https://taskfile.dev/), [`Taskfile.yaml`](./Taskfile.yaml) exposes three convenience tasks —
...
> [!NOTE]
>
> As described in [CONTRIBUTING.md](./CONTRIBUTING.md), it's recommended to configure `.githooks/` after cloning to
> enable automatic formatting and validation on every commit.
